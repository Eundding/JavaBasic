...
public class _01_String1 {
    public static void main(String[] args) {
        ...
        System.out.println(s.indexOf("Java")); // index 7부터 시작
        System.out.println(s.indexOf("C#")); // 포함되지 않는다면 -1

        System.out.println(s.indexOf("and")); // 처음 일치하는 index 12
        System.out.println(s.lastIndexOf("and")); // 마지막으로 일치하는 index 23
